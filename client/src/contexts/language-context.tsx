...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'liveTrading.loadMore': 'Load More',
    ...
    'liveTrading.totalTrades': 'Total Trades',
  ...
  ko: {
    ...
    'liveTrading.totalTrades': '총 거래 수',
