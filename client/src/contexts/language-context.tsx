...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'tradeDetail.priceComparison': 'Price Comparison',
    'tradeDetail.tradePrice': 'Trade Price:',
    'tradeDetail.currentPrice': 'Current Price:',
    'tradeDetail.perShareComparison': 'Per share comparison',
  ...
  ko: {
    ...
    'tradeDetail.currentPrice': '현재 가격:',
  ...
  ja: {
    ...
    // WebSocket and Connection
    'connection.liveFeedActive': 'ライブデータフィード有効 - リアルタイムSEC提出書類監視',
    ...
    'placeholder.preferredLanguage': 'お好みの言語を選択',
    ...
    'alerts.type.company': '企業名',
    'alerts.type.trader': 'トレーダー役職',
    
    // Search page
    'search.title': '検索 & フィルター',
    ...
    'alerts.active': 'アクティブ',
    'alerts.paused': '一時停止',
    'alerts.noAlerts': 'まだアラートが設定されていません',
    'alerts.createFirst': '以下で最初のアラートを作成してください',
    'alerts.noMatches': '最近の一致がありません',
    'alerts.setupMatches': '一致を確認するには、アラートを設定してください',
    'alerts.condition.greaterThan': '以上',
    'alerts.condition.lessThan': '未満',
    'alerts.condition.equals': '一致',
    'alerts.condition.contains': '含む',
    'alerts.placeholder.name': '例: 大型Apple取引',
    
    // Settings page
    'settings.themeDescription': 'お好みのテーマを選択してください',
  ...
  zh: {
    ...
    'page.livetrading.subtitle': '基于AI分析的实时内幕交易活动',
    'page.search.placeholder': '搜索公司、股票代码、交易员、职位...',
    ...
    // WebSocket and Connection
    'connection.liveFeedActive': '实时数据源已激活 - 实时SEC文件监控',
    'connection.connectionLost': '连接丢失 - 正在尝试重新连接...',
    'connection.liveFeed': '实时源',
    ...
    'placeholder.preferredLanguage': '选择您喜欢的语言',
    ...
    'search.dateRange.7d': '最近7天',
    'search.dateRange.30d': '最近30天',
    'search.dateRange.90d': '最近90天',
    ...
    'tradeDetail.currentPrice': '当前价格：',
    'tradeDetail.perShareComparison': '每股比较',
    
    // Dashboard Stats
    'stats.fromLastWeek': '相比上周',
