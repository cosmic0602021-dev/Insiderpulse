...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'trial.benefits.filter': 'Advanced Filtering & Search',
    'trial.benefits.filterDesc': 'Detailed search by trade type, company, and insider',
  ...
  ko: {
    ...
    'trial.benefits.filter': '고급 필터링 및 검색',
    'trial.benefits.filterDesc': '거래 유형, 기업, 내부자별 상세 검색',
  ...
  ja: {
    ...
    'trial.benefits.filter': '高度なフィルタリングと検索',
    'trial.benefits.filterDesc': '取引タイプ、企業、インサイダー別の詳細検索',
  ...
  zh: {
    ...
    'trial.benefits.filter': '高级筛选与搜索',
    'trial.benefits.filterDesc': '按交易类型、公司和内幕人士进行详细搜索',
