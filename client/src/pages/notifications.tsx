  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      {isMobile && !isInstalled && !ENV_CONFIG.isAppintos && (
        <Card className="border-neutral-700 dark:border-neutral-700 bg-neutral-900/50">
          <CardContent className="py-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-base mb-2 text-neutral-100">
                  앱 설치로 푸시 알림 받기
                </h3>
                <p className="text-sm text-neutral-400 mb-3">
                  푸시 알림을 받으려면 홈 화면에 앱을 추가하세요.
                </p>
                  ...
                  <div className="bg-neutral-800/50 rounded-lg p-3 space-y-2">
                    ...
                    <ol className="text-sm text-neutral-400 space-y-1 list-decimal list-inside">
                      <li className="flex items-center gap-2">
                        <span>Safari 하단</span>
                        <Share className="h-4 w-4 inline text-neutral-500" />
                        <span>공유 버튼</span>
                      </li>
                      <li>"홈 화면에 추가" 선택</li>
                    </ol>
                  ...
                  <div className="bg-neutral-800/50 rounded-lg p-3 space-y-2">
                    ...
                    {deferredPrompt ? (
                      ...
                      <ol className="text-sm text-neutral-400 space-y-1 list-decimal list-inside">
                        <li className="flex items-center gap-2">
                          <span>Chrome 메뉴</span>
                          <MoreVertical className="h-4 w-4 inline text-neutral-500" />
                        </li>
                        <li>"앱 설치" 또는 "홈 화면에 추가"</li>
                      </ol>
                    )}
                  </div>
                ) : (
