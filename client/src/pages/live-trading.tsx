      ...
      <GlassCard variant="elevated" className="p-4 sm:p-6">
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full flex justify-center">
            <div className="max-w-2xl w-full px-4 py-3 bg-white/5 border border-white/10 backdrop-blur-xl rounded-xl">
              <div className="flex flex-col gap-3 w-full">
              {/* Trade Type Filter (All/Buy/Sell) */}
              ...
              {/* Transaction Detail Filter (Core/All) */}
              <TransactionTypeFilter
