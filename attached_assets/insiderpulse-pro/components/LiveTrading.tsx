...
import { formatCurrency, formatNumber, formatPercent, TRANSLATIONS } from '../utils';
...
const LiveTrading: React.FC<LiveTradingProps> = ({ data, onSelectTrade, lang, isPro, onUpgrade }) => {
  ...
  // Sort data by date descending to ensure "Top" items are the newest/real-time ones
  ...
  // Simulating the top 3 items being "Live/Real-time" which are locked for free users
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#050505]">
       ...
       {/* Data Table - Responsive Grid to avoid horizontal scroll */}
       <div className="flex-1 overflow-y-auto relative custom-scrollbar">
           ...
           <div>
                {/* LOCKED REAL-TIME ZONE (For Outsider/Free Users) */}
                {!isPro && (
                    <div className="relative border-b border-neutral-800 bg-[#080808] overflow-hidden">
                        {/* Animated Striped Warning Background */}
                ...
                {/* VISIBLE / DELAYED DATA */}
                <div className="relative z-10">
                        {/* If PRO, show all. If FREE, show historical only */}
                        ...
                        >
                            <div className="pl-2 font-bold text-neutral-300 group-hover:text-white flex flex-col">
                                ...
                                {/* Show insider name on mobile only below ticker */}
                            ...
                            <div className="hidden md:block text-neutral-600 text-[9px] uppercase">{tData[trade.relation] || trade.relation}</div>
