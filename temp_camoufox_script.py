...
def make_request():
    try:
        ...
        with Camoufox(
            ...
            response = page.goto('https://www.sec.gov/Archives/edgar/data/2086420/000208642025000004/xslF345X04/ownership.xml', wait_until='domcontentloaded', timeout=30000)
            
            # For XML files, get the raw response
            if 'https://www.sec.gov/Archives/edgar/data/2086420/000208642025000004/xslF345X04/ownership.xml'.endswith('.xml') or 'application/xml' in 'application/xml':
