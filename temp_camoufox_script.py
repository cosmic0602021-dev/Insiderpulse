...
def make_request():
    try:
        ...
        with Camoufox(
            ...
            response = page.goto('https://www.sec.gov/Archives/edgar/data/886982/000119312525208236/form4.xml', wait_until='domcontentloaded', timeout=30000)
            
            # For XML files, get the raw response
            if 'https://www.sec.gov/Archives/edgar/data/886982/000119312525208236/form4.xml'.endswith('.xml') or 'application/xml' in 'application/xml':
