...
def make_request():
    try:
        ...
        with Camoufox(
            ...
            response = page.goto('https://www.sec.gov/Archives/edgar/data/1579877/000208642025000004/xslF345X05/ownership.xml', wait_until='domcontentloaded', timeout=30000)
            
            # For XML files, get the raw response
            if 'https://www.sec.gov/Archives/edgar/data/1579877/000208642025000004/xslF345X05/ownership.xml'.endswith('.xml') or 'application/xml' in 'application/xml':
