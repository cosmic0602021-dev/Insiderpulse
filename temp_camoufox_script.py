...
def make_request():
    try:
        ...
        with Camoufox(
            ...
            response = page.goto('https://www.sec.gov/Archives/edgar/data/1831410/000183141025000004/primary_doc.xml', wait_until='domcontentloaded', timeout=30000)
            
            # For XML files, get the raw response
            if 'https://www.sec.gov/Archives/edgar/data/1831410/000183141025000004/primary_doc.xml'.endswith('.xml') or 'application/xml' in 'application/xml':
