...
def make_request():
    try:
        ...
        with Camoufox(
            ...
            response = page.goto('https://www.sec.gov/Archives/edgar/data/1818331/000194411925000005/xslF345X01/ownership.xml', wait_until='domcontentloaded', timeout=30000)
            
            # For XML files, get the raw response
            if 'https://www.sec.gov/Archives/edgar/data/1818331/000194411925000005/xslF345X01/ownership.xml'.endswith('.xml') or 'application/xml' in 'application/xml':
