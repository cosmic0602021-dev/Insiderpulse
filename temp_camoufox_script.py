...
def make_request():
    try:
        ...
        with Camoufox(
            ...
            response = page.goto('https://www.sec.gov/Archives/edgar/data/1869758/000162828025042241/xslF345X03/ownership.xml', wait_until='domcontentloaded', timeout=30000)
            
            # For XML files, get the raw response
            if 'https://www.sec.gov/Archives/edgar/data/1869758/000162828025042241/xslF345X03/ownership.xml'.endswith('.xml') or 'application/xml' in 'application/xml':
